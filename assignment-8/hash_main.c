...
int main (int argc, const char * argv[]) {
    ...
    assertTrue(containsKey(hashTable, "despair") == 0, "Search for 'despair' after remove");
    ...
    removeKey(hashTable2, "yuck"); //Should print some type of 'not found' message
    assertTrue(containsKey(hashTable2, "despair") == 1, "Search for 'despair'");
    removeKey(hashTable2, "despair");
    assertTrue(containsKey(hashTable2, "despair") == 0, "Search for 'despair' after remove");
    assertTrue(containsKey(hashTable2, "belief") == 1, "Search for 'belief'");
    removeKey(hashTable2, "belief");
    assertTrue(containsKey(hashTable2, "belief") == 0, "Search for 'belief' after remove");
    assertTrue(containsKey(hashTable2, "degree") == 1, "Search for 'degree'");
    removeKey(hashTable2, "degree");
    assertTrue(containsKey(hashTable2, "degree") == 0, "Search for 'degree' after remove");
    */
