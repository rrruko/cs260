 ...
 * Preconditions: There must be enough free memory to perform the allocation.
 ...
 * Preconditions: `people` must be an array of length COUNT.
 * Postconditions: All persons have an age between 18 and 90 and a sex of M or
 * F.
 */
void generate(struct person* people) {
 ...
 */
void stats(struct person* people) {
    /* Compute and print the minimum, maximum and average age of the ten
     * persons */
